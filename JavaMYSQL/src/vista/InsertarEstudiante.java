...
public class InsertarEstudiante extends javax.swing.JFrame {
    ...
    /*
    En este metodo se hace un pequeño truco para que las imagenes queden
    del mismo tamaño que el Jlabel.
    */
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        java.awt.Image im = Toolkit.getDefaultToolkit().createImage(Rutaimage);
    ...
    /*
    El metodo formWindowOpened lo que hace es:
    establece que la ruta de imagen que inicializamos al inicio ahora será una
    indicada por mí para que la foto del usuario ahora sea una por defecto.
    Adicionalmente: formwindowopened es un evento del panel de interfaz grafica
    y no es un metodo creado por mi desde 0. Es algo de netbeans.
    */
    
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        Rutaimage = "imagenes112/img1.png";
        String img3D = "imagenes112/img1.png";
        Image im1 = Toolkit.getDefaultToolkit().createImage(img3D);
